...
#define VERBOSE
         ...
         */
        KokkosWrap::LocalMatrix<int32_t, int32_t, float> A_remote(A_holder.form_mmiocsx(kwd_A.partitioning->local_rows, kwd_A.partitioning->local_cols, A_tile_nnz, kwd_A.mmio_csx->majordim));
